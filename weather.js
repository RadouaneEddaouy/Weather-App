  ...
  fetch(
    ...
    .then((json) => {
      ...
      switch (json.weather[0].main) {
        case "Clear":
          img.src = "imgs/4102328_hot_sun_weather_icon.png";
          break;

        case "Rain":
          img.src = "imgs/4102320_cloud_heavy rain_rain_weather_icon.png";
          break;

        case "Snow":
          img.src = "imgs/cloudy-37012_1280.webp";
          break;
        case "Mist":
        ...
        case "Clouds":
          img.src = "imgs/4102315_cloud_weather_icon.png";
          break;

        case "Haze":
          img.src = "imgs/4102323_cloud_cold_snow_weather_icon.png";
          break;
